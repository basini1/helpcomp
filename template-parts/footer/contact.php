<div class="flex flex-col gap-y-6">
    <address class="not-italic max-w-60">
        <strong class="font-medium text-white mb-6 block">Studio Usług Informatycznych
            HELPCOMP&nbsp;s.c. Adam Wielki,
            Ryszard Wielki</strong>
        Jana Smolenia 18/24<br>
        41-902 Bytom, woj. śląskie
    </address>
    <p class="flex flex-col items-start gap-y-1">
        <a class="flex flex-wrap gap-x-3 group" href="#">
            ...
            <span class="block text-helpcompGray group-hover:text-helpcompBlue transition-colors duration-300" href="#">32 280 32 69</span>
        </a>
        <a class="flex flex-wrap gap-x-3 group" href="#">
            <span class="block text-helpcompRed">
                <svg class="translate-y-0.5 relative" xmlns="http://www.w3.org/2000/svg" width="18.485" height="18.518" viewBox="0 0 18.485 18.518">
            ...
            <span class="block text-helpcompGray group-hover:text-helpcompBlue transition-colors duration-300" href="#">32 396 09 14</span>
        </a>
    </p>
</div>